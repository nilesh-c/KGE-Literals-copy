...
literal_data = pd.read_csv('../data/fb15k-literal/entity_literal.csv',index_col=0)
literal_count = pd.read_csv('../data/fb15k-literal/frequency-count.txt', header = None, sep = '\t')
...
df.to_csv('../data/fb15k-literal/filtered-frequency-count.txt', sep='\t', header=None)
